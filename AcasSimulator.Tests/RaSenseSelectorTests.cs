...
public class RaSenseSelectorTests
{
    ...
    public void SelectSense_IntruderAbove_SelectsDescend()
    {
        ...
        Aircraft intruder = new Aircraft("INT1", "000000", 3.0, 0.0, 30300.0, 360.0, 270.0, 0.0);
    ...
    public void SelectSense_IntruderBelow_SelectsClimb()
    {
        ...
        // ARRANGE:
        Aircraft ownship = new Aircraft("OWN1", "000000", 0.0, 0.0, 30000.0, 360.0, 90.0, 0.0);
        Aircraft intruder = new Aircraft("INT1", "000000", 3.0, 0.0, 29700.0, 360.0, 270.0, 0.0);
    ...
    public void SelectSense_LowAltitude_InhibitsDescendAndForcesClimb()
    {
        ...
        // ARRANGE:
        Aircraft ownship = new Aircraft("OWN1", "000000", 0.0, 0.0, 800.0, 150.0, 90.0, 0.0);
        Aircraft intruder = new Aircraft("INT1", "000000", 1.0, 0.0, 1100.0, 150.0, 270.0, 0.0);
